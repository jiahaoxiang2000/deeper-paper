...
\begin{table}[h]
	...
	\begin{tabular}{lcccc}
		...
		\hline
		ECDSA P-256     & 252,000         & 1.50               & 666.7            & 1.00$\times$      \\
		ML-DSA-44       & 25,368,000      & 151.0              & 6.6              & 100.7$\times$     \\
		ML-DSA-65       & 41,832,000      & 249.0              & 4.0              & 166.0$\times$     \\
		ML-DSA-87       & 59,976,000      & 357.0              & 2.8              & 238.0$\times$     \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{lccccc}
		...
		\hline
		ECDSA P-256     & 10 bytes         & 1,544,400       & 9.19               & 108.8            & 1.00$\times$      \\
		ECDSA P-256     & 50 bytes         & 1,577,280       & 9.39               & 106.5            & 1.00$\times$      \\
		ECDSA P-256     & 100 bytes        & 1,610,160       & 9.59               & 104.3            & 1.00$\times$      \\
		\hline
		ML-DSA-44       & 10 bytes         & 110,376,000     & 657.0              & 1.52             & 71.5$\times$      \\
		ML-DSA-44       & 50 bytes         & 111,384,000     & 663.0              & 1.51             & 70.6$\times$      \\
		ML-DSA-44       & 100 bytes        & 112,392,000     & 669.0              & 1.49             & 69.8$\times$      \\
		\hline
		ML-DSA-65       & 10 bytes         & 141,456,000     & 842.0              & 1.19             & 91.6$\times$      \\
		ML-DSA-65       & 50 bytes         & 143,304,000     & 853.0              & 1.17             & 90.8$\times$      \\
		ML-DSA-65       & 100 bytes        & 145,152,000     & 864.0              & 1.16             & 90.1$\times$      \\
		\hline
		ML-DSA-87       & 10 bytes         & 188,496,000     & 1,122.0            & 0.89             & 122.1$\times$     \\
		ML-DSA-87       & 50 bytes         & 190,848,000     & 1,136.0            & 0.88             & 121.0$\times$     \\
		ML-DSA-87       & 100 bytes        & 193,200,000     & 1,150.0            & 0.87             & 119.9$\times$     \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{lccccc}
		...
		\textbf{Scheme} & \textbf{Payload} & \textbf{Cycles} & \textbf{Time (ms)} & \textbf{Ops/sec} & \textbf{Overhead} \\
		\hline
		ECDSA P-256     & 10 bytes         & 2,688,000       & 16.00              & 62.5             & 1.00$\times$      \\
		ECDSA P-256     & 50 bytes         & 2,721,600       & 16.20              & 61.7             & 1.00$\times$      \\
		ECDSA P-256     & 100 bytes        & 2,755,200       & 16.40              & 61.0             & 1.00$\times$      \\
		\hline
		ML-DSA-44       & 10 bytes         & 69,888,000      & 416.0              & 2.40             & 26.0$\times$      \\
		ML-DSA-44       & 50 bytes         & 70,560,000      & 420.0              & 2.38             & 25.9$\times$      \\
		ML-DSA-44       & 100 bytes        & 71,232,000      & 424.0              & 2.36             & 25.9$\times$      \\
		\hline
		ML-DSA-65       & 10 bytes         & 88,704,000      & 528.0              & 1.89             & 33.0$\times$      \\
		ML-DSA-65       & 50 bytes         & 89,544,000      & 533.0              & 1.88             & 32.9$\times$      \\
		ML-DSA-65       & 100 bytes        & 90,384,000      & 538.0              & 1.86             & 32.8$\times$      \\
		\hline
		ML-DSA-87       & 10 bytes         & 118,104,000     & 703.0              & 1.42             & 43.9$\times$      \\
		ML-DSA-87       & 50 bytes         & 119,280,000     & 710.0              & 1.41             & 43.8$\times$      \\
		ML-DSA-87       & 100 bytes        & 120,456,000     & 717.0              & 1.39             & 43.7$\times$      \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{lcccc}
		...
		\hline
		ECDSA P-256     & 10 bytes         & 82 bytes             & 18 bytes               & 4.6$\times$             \\
		ECDSA P-256     & 50 bytes         & 122 bytes            & 58 bytes               & 2.1$\times$             \\
		ECDSA P-256     & 100 bytes        & 172 bytes            & 108 bytes              & 1.6$\times$             \\
		\hline
		ML-DSA-44       & 10 bytes         & 2,438 bytes          & 18 bytes               & 135.4$\times$           \\
		ML-DSA-44       & 50 bytes         & 2,478 bytes          & 58 bytes               & 42.7$\times$            \\
		ML-DSA-44       & 100 bytes        & 2,528 bytes          & 108 bytes              & 23.4$\times$            \\
		\hline
		ML-DSA-65       & 10 bytes         & 3,327 bytes          & 18 bytes               & 184.8$\times$           \\
		ML-DSA-65       & 50 bytes         & 3,367 bytes          & 58 bytes               & 58.1$\times$            \\
		ML-DSA-65       & 100 bytes        & 3,417 bytes          & 108 bytes              & 31.6$\times$            \\
		\hline
		ML-DSA-87       & 10 bytes         & 4,645 bytes          & 18 bytes               & 258.1$\times$           \\
		ML-DSA-87       & 50 bytes         & 4,685 bytes          & 58 bytes               & 80.8$\times$            \\
		ML-DSA-87       & 100 bytes        & 4,735 bytes          & 108 bytes              & 43.8$\times$            \\
		\hline
	\end{tabular}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{lccccc}
		...
		\hline
		ECDSA P-256     & 10 bytes         & 108.7             & Signature gen.      & 1.00$\times$      \\
		ECDSA P-256     & 50 bytes         & 106.4             & Signature gen.      & 1.00$\times$      \\
		ECDSA P-256     & 100 bytes        & 104.2             & Signature gen.      & 1.00$\times$      \\
		\hline
		ML-DSA-44       & 10 bytes         & 1.52              & Signature gen.      & 71.5$\times$      \\
		ML-DSA-44       & 50 bytes         & 1.51              & Signature gen.      & 70.5$\times$      \\
		ML-DSA-44       & 100 bytes        & 1.49              & Signature gen.      & 69.9$\times$      \\
		\hline
		ML-DSA-65       & 10 bytes         & 1.18              & Signature gen.      & 92.1$\times$      \\
		ML-DSA-65       & 50 bytes         & 1.17              & Signature gen.      & 90.9$\times$      \\
		ML-DSA-65       & 100 bytes        & 1.16              & Signature gen.      & 89.8$\times$      \\
		\hline
		ML-DSA-87       & 10 bytes         & 0.89              & Signature gen.      & 122.1$\times$     \\
		ML-DSA-87       & 50 bytes         & 0.88              & Signature gen.      & 120.9$\times$     \\
		ML-DSA-87       & 100 bytes        & 0.87              & Signature gen.      & 119.8$\times$     \\
		\hline
	\end{tabular}
\end{table}

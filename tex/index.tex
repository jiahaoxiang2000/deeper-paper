...
The remainder of this paper is organized as follows: Section~\ref{sec:related} presents background and related work. Section~\ref{sec:architecture} describes the system architecture. Section~\ref{sec:adaptive} presents the adaptive protocol. Section~\ref{sec:methodology} details experimental methodology. Section~\ref{sec:results} presents results and analysis. Section~\ref{sec:conclusion} concludes with implications for deployment.
...
\section{Adaptive Security Level Selection}\label{sec:adaptive}
...
\subsection{Protocol-Level Overhead}
...
\subsubsection{Sustainable Throughput}
